...
export function HomeScreen({ onOpenNote, onNewNote, onOpenTemplates, onOpenDonate, onOpenTeams, onOpenBilling, isLoggedIn, authUser, theme }: HomeScreenProps) {
